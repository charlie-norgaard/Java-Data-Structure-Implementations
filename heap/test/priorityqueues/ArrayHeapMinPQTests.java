...
public class ArrayHeapMinPQTests extends BaseTest {
    ...
    class NewEmpty {
        ...
        @Test
        void randomTest1() {
            ArrayHeapMinPQ<String> arrayPQ = new ArrayHeapMinPQ<>();
            ...
            arrayPQ.add("nine", 9);
            arrayPQ.add("ten", 10);
            arrayPQ.add("eleven", 12);
            arrayPQ.add("twelve", 12);
            arrayPQ.add("thirteen", 13);
            arrayPQ.add("fourteen", 14);
            arrayPQ.add("fifteen", 15);
            arrayPQ.add("sixteen", 16);
            arrayPQ.add("seventeen", 17);
            arrayPQ.add("eighteen", 18);
            arrayPQ.add("nineteen", 19);
            arrayPQ.add("twenty", 20);
            System.out.println("ArrayHeapMinPQ:");
            System.out.print("[");
            for (int i = 0; i < 20; i++) {
                System.out.print(arrayPQ.removeMin() + ", ");
            }
            System.out.print("]");
            System.out.println();
            naivePQ.add("one", 1);
            ...
            naivePQ.add("nine", 9);
            naivePQ.add("ten", 10);
            naivePQ.add("eleven", 12);
            naivePQ.add("twelve", 12);
            naivePQ.add("thirteen", 13);
            naivePQ.add("fourteen", 14);
            naivePQ.add("fifteen", 15);
            naivePQ.add("sixteen", 16);
            naivePQ.add("seventeen", 17);
            naivePQ.add("eighteen", 18);
            naivePQ.add("nineteen", 19);
            naivePQ.add("twenty", 20);
            System.out.println("NaiveMinPQ:");
            System.out.print("[");
            for (int i = 0; i < 20; i++) {
                System.out.print(naivePQ.removeMin() + ", ");
            }
            System.out.print("]");
        }
